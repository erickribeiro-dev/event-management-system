...
SECRET_KEY = os.environ.get("EMS_SECRET_KEY")
if not SECRET_KEY:
    raise ImproperlyConfigured("EMS_SECRET_KEY environment variable is not set.")
...
# TODO: implement Uploaded media files
# MEDIA_ROOT = os.path.join(BASE_DIR, "media")
# MEDIA_URL = "/media/"

# Users, Accounts and Auth settings
